...
class ResidualLearningMPC:
    ...
    def preparation(self, i=0):
        ...
        for stage in range(self.N):
            ...
            self.solve_stats["timings"]["integrate_acados"][i] += self.sim_solver.get(
                "time_tot"
            )
    ...
    def feedback(self, i=0):
        ...
        self.solve_stats["timings"]["solve_qp_acados"][i] += self.ocp_solver.get_stats(
            "time_tot"
        )
